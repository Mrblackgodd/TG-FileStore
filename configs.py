...
class Config(object):
	...
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "2034654684"))
...
│
├🔸👨‍💻 **Developer:** [@EMPERORns](https://t.me/gfdgfdhdttrhh) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/+hz0YzDdMioE0OWFl)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://t.me/gfdgfdhdttrhh)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@EMPERORns](https://t.me/gfdgfdhdttrhh) 
